...
mod tests {
    ...
    #[test]
    fn change_representation() -> Result<(), Error> {
        let mut rng = thread_rng();
        let ctx = Arc::new(Context::new(MODULI, 16)?);
    ...
    #[test]
    fn override_representation() -> Result<(), Error> {
        let mut rng = thread_rng();
        let ctx = Arc::new(Context::new(MODULI, 16)?);
    ...
    #[test]
    fn mod_switch_down_to() -> Result<(), Error> {
        let mut rng = thread_rng();
        let ntests = 100;
